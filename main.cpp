...
void kitapEkle(Kitap kitaplar[], int &kitapSayisi) {
    ...
    cout << "Kitap adı: "; getline(cin, kitaplar[kitapSayisi].kitapAdi);
    cout << "Yazar adı: "; getline(cin, kitaplar[kitapSayisi].yazarAdi);
    cout << "Yayın yılı: "; cin >> kitaplar[kitapSayisi].yayinYili; cin.ignore();
    cout << "ISBN numarası: "; getline(cin, kitaplar[kitapSayisi].isbn);
    kitapSayisi++;
...
void kitapListele(const Kitap kitaplar[], int kitapSayisi) {
    if (kitapSayisi == 0) {
        cout << "Listelenecek kitap bulunamadı." << endl;
        return;
    }
...
void kitapAra(const Kitap kitaplar[], int kitapSayisi) {
    ...
    if (!bulundu) cout << "Kitap bulunamadı." << endl;
}

void kitapSil(Kitap kitaplar[], int &kitapSayisi) {
    string silinecek; cout << "Silmek istediğiniz kitabın adı veya ISBN numarasını girin: ";
...
int main() {
    ...
    do {
        ...
        switch (secim) {
            ...
            case 6: dosyayaYaz(kitaplar, kitapSayisi); cout << "Programdan çıkılıyor..." << endl; break;
